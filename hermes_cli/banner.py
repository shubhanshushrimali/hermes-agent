...
# =========================================================================
# Aizen Version Branding
# =========================================================================

AIZEN_SUBTITLE = """[italic dim #818CF8]— Aizen Version[/]
[italic dim #52525B]"Yōkoso, watashi no Soul Society"[/]"""

AIZEN_ZANPAKUTO = """[#6366F1]⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣠⠔⠊⠉⠉⠉⠉⠑⠢⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[/]
[#818CF8]⠀⠀⠀⠀⠀⠀⠀⠀⢀⡴⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⢦⡀⠀⠀⠀⠀⠀⠀⠀[/]
[#818CF8]⠀⠀⠀⠀⠀⠀⠀⡰⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠘⢆⠀⠀⠀⠀⠀⠀[/]
[#6366F1]⠀⠀⠀⠀⠀⠀⡴⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⢣⠀⠀⠀⠀⠀[/]
[#818CF8]⠀⠀⠀⠀⠀⡜⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⡆⠀⠀⠀⠀[/]
...
def is_aizen_mode() -> bool:
    """Check if Aizen branding is enabled (default: True for Aizen Version)."""
    return os.environ.get("HERMES_SKIN", "aizen").lower() == "aizen"


def get_banner_art() -> str:
    """Return the appropriate ASCII art based on active skin."""
    if is_aizen_mode():
        return AIZEN_ZANPAKUTO
    return HERMES_CADUCEUS


def get_banner_subtitle() -> str:
    """Return the subtitle for the banner."""
    if is_aizen_mode():
        return AIZEN_SUBTITLE
    return ""
